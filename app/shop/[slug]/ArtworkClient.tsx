...
export default function ArtworkClient({
   ...
   * FETCH ARTWORK
   *
   * The server already provides the artwork for SEO.
   *
   * We only fetch again if the server did not
   * provide the artwork.
   * =========================================================
   */
