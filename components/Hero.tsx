    ...
    <section className="relative h-screen min-h-[700px] overflow-hidden bg-[var(--deep-earth)]">
      ...
      >
        ...
        >
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-5">
            ...
            <div className="relative flex h-3 w-3 items-center justify-center">
              <span className="block h-2.5 w-2.5 rotate-45 bg-[var(--ochre)]" />
            </div>
        ...
        <nav className="mt-8 flex items-center gap-8">
          <Link
            href="/about"
            className="text-[15px] uppercase tracking-[0.2em] text-white transition-opacity duration-300 hover:opacity-50 md:text-[17px]"
          >
            About
          </Link>
